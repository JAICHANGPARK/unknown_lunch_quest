...
class MobileRecordPrintPagePage extends StatefulWidget {
  final List<Record> recordItems;

  MobileRecordPrintPagePage({this.recordItems});

  @override
  _MobileRecordPrintPageState createState() => _MobileRecordPrintPageState();
}

class _MobileRecordPrintPageState extends State<MobileRecordPrintPagePage> {
  List<Record> records = [];
